...
const LabDashboard = () => {
  ...
  const updateReport = async (event) => {
    ...
    try {
      ...
      if (reportForm.status === 'COMPLETED' && !finalReportUrl) {
        setNotice('You must upload a report document before marking this request as Completed.');
        setSaving(false);
        return;
      }
